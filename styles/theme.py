...
def market_snapshot(last):
    ...
    ">
        ...
        <table style="width:100%; font-size:12px;">
            ...
            <tr>
                <td style="color:#A0A0A0;">ORB High</td>
                <td align="right"><b>{last['ORB_High']:.2f}</b></td>
            </tr>

            <tr>
                <td style="color:#A0A0A0;">ORB Low</td>
                <td align="right"><b>{last['ORB_Low']:.2f}</b></td>
            </tr>
    ...
    ">
        ...
        <table style="width:100%; font-size:12px;">
            ...
            <tr>
                ...
                <td align="right"><b>{ce['Volume']:,}</b></td>
                <td align="right"><b>{pe['Volume']:,}</b></td>
            </tr>

            <tr>
                <td style="color:#A0A0A0;">OI</td>
                <td align="right"><b>{ce['OI']:,}</b></td>
                <td align="right"><b>{pe['OI']:,}</b></td>
            </tr>
        </table>
